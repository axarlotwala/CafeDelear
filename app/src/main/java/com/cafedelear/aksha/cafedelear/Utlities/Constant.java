...
public class Constant {
    ...
    private static final String Base_Url = "http://192.168.0.103/CafeResturant/Delear/";

    public static final String Register_url = Base_Url+"Register_Delear.php";
    public static final String Login_url = Base_Url+"Login_Delear.php";
    ...
    public static final String All_Menu = Base_Url+"Menu_List.php?delear_id=&&cat_id=";
